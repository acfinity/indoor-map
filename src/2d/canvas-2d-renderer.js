...
export default class Renderer {
    ...
    scale(scale, { x: originX = this.canvasSize.width / 2, y: originY = this.canvasSize.height / 2 } = {}) {
    ...
    localToWorld(pt) {
        return new Point(
            (pt.x + this.transform.translate[0] + this.map.wrapperSize.width) >> 1,
    ...
    worldToLocal(pt) {
        return new Point(
            (pt.x - this.transform.translate[0] - this.canvasSize.width / 2) / this.transform.scale,
    ...
    clearBg() {
        ...
        this.context.fillRect(
            0,
            0,
            this.canvasSize.width * this.devicePixelRatio,
            this.canvasSize.height * this.devicePixelRatio
        )
        this.context.restore()
    }
}
